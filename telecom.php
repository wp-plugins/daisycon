...
class generalCom{
	...
	public function adminTelecom(){
		...
		$output = 	'<div style="width:900px;">
					...
					<br/><br/>
					Plak onderstaande shorttag in je blogpost of pagina en de vergelijker verschijnt direct op je website. <a href="http://mobielvergelijker.affiliateprogramma.eu/" target="_blank">Klik hier om de demowebsite te bekijken</a>.
					<br/><br/>
